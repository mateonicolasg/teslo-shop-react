                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        {
                                            errors.price && (
                                                <p className="text-red-500 text-sm">El precio es requerido y debe ser mayor a 0</p>
                                            )
                                        }
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        {
                                            errors.stock && (
                                                <p className="text-red-500 text-sm">El stock es requerido y debe ser mayor a 0</p>
                                            )
                                        }
                                    </div>
                                </div>
